...
export const apiReferenceSidebar: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Image via unified run', link: '/api-reference/models/image' },
      { text: 'Video via unified run', link: '/api-reference/models/video' },
      { text: 'Audio via unified run', link: '/api-reference/models/audio' },
  ...
  {
    text: 'Protocol endpoints',
    collapsed: true,
    items: [
      { text: 'OpenAI Responses', link: '/api-reference/responses' },
