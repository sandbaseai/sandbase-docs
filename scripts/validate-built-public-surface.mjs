...
for (const excludedUrl of ['/docs/README', '/docs/CONTRIBUTING', '/docs/DEPLOYMENT', '/docs/admin/api-keys', '/docs/setup/cli', '/docs/setup/groups', '/docs/agents/deployments', '/docs/store/models', '/docs/api-reference/volcengine-contents-generations']) {
  assert.ok(!sitemap.includes(`<loc>https://www.agrouter.ai${excludedUrl}</loc>`), `${excludedUrl} must not be indexed in the sitemap`)
}
...
assert.match(storeModelsAlias, /<link rel="canonical" href="https:\/\/www\.agrouter\.ai\/docs\/models\/">/, 'Legacy Store Models alias must canonicalize to the Models page')
